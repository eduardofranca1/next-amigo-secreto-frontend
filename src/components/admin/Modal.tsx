...
export const Modal = ({ onClose, children }: Props) => {
  return (
    //fixed left-0 top-0 right-0 bottom-0 vai pegar o contéudo de todo o navegador
    // overflow-y-auto = se o conteúdo do modal for muito grande terá uma barra de rolagem
